...
public class Policy implements Serializable {
    ...
    public Policy startDate(String startDate) {
    ...
    public Policy endDate(String endDate) {
    ...
    public Policy premium(String premium) {
    ...
    public Policy deductible(String deductible) {
    ...
    public Policy timestamp(String timestamp) {
