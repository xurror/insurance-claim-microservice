...
describe('Service Tests', () => {
  describe('Claim Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Claim(0, 'AAAAAAA', 'AAAAAAA', ClaimStatus.UnderReview, ClaimOutcomes.Settled);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Claim', () => {
        ...
        service.create(new Claim()).subscribe(resp => (expectedResult = resp.body));
