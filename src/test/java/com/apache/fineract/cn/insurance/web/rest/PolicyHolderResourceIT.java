...
public class PolicyHolderResourceIT {
    ...
    public void createPolicyHolder() throws Exception {
        ...
        restPolicyHolderMockMvc.perform(post("/api/policy-holders").with(csrf())
    ...
    public void updatePolicyHolder() throws Exception {
        ...
        restPolicyHolderMockMvc.perform(put("/api/policy-holders").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deletePolicyHolder() throws Exception {
        ...
        restPolicyHolderMockMvc.perform(delete("/api/policy-holders/{id}", policyHolder.getId()).with(csrf())
