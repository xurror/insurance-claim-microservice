...
public class PaymentScheduleResourceIT {
    ...
    public void createPaymentSchedule() throws Exception {
        ...
        restPaymentScheduleMockMvc.perform(post("/api/payment-schedules").with(csrf())
    ...
    public void updatePaymentSchedule() throws Exception {
        ...
        restPaymentScheduleMockMvc.perform(put("/api/payment-schedules").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deletePaymentSchedule() throws Exception {
        ...
        restPaymentScheduleMockMvc.perform(delete("/api/payment-schedules/{id}", paymentSchedule.getId()).with(csrf())
