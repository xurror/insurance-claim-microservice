...
public class PolicyResourceIT {
    ...
    private static final String DEFAULT_DEDUCTIBLE = "AAAAAAAAAA";
    private static final String UPDATED_DEDUCTIBLE = "BBBBBBBBBB";
    ...
    public void createPolicy() throws Exception {
        ...
        // Create the Policy
        restPolicyMockMvc.perform(post("/api/policies").with(csrf())
    ...
    public void updatePolicy() throws Exception {
        ...
        restPolicyMockMvc.perform(put("/api/policies").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deletePolicy() throws Exception {
        ...
        // Delete the policy
        restPolicyMockMvc.perform(delete("/api/policies/{id}", policy.getId()).with(csrf())
