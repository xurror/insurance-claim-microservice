...
public class MTAResourceIT {
    ...
    public void createMTA() throws Exception {
        ...
        // Create the MTA
        restMTAMockMvc.perform(post("/api/mtas").with(csrf())
    ...
    public void updateMTA() throws Exception {
        ...
        restMTAMockMvc.perform(put("/api/mtas").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteMTA() throws Exception {
        ...
        // Delete the mTA
        restMTAMockMvc.perform(delete("/api/mtas/{id}", mTA.getId()).with(csrf())
