...
public class EndorsementResourceIT {
    ...
    public void createEndorsement() throws Exception {
        ...
        restEndorsementMockMvc.perform(post("/api/endorsements").with(csrf())
    ...
    public void updateEndorsement() throws Exception {
        ...
        restEndorsementMockMvc.perform(put("/api/endorsements").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteEndorsement() throws Exception {
        ...
        restEndorsementMockMvc.perform(delete("/api/endorsements/{id}", endorsement.getId()).with(csrf())
